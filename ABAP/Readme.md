...
* ICM and SAP web dispatcher shares the same code basis. Web dispatcher performs load balancing, and passes requests to ICM on the connected application servers rather than to work processes. 
