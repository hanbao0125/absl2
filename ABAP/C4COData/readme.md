...
Scoping: Communication and Information Exchange Next navigation step Integration with External Applications and Solutions Next navigation step Integration into Sales, Service, and Marketing Processes Next navigation step Group: Sales Quotes End of the navigation path.
